    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Screenshots", t => t.ScreenshotDbId)
                .Index(t => t.TradingDayId)
                .Index(t => t.TradingAccountId)
                .Index(t => t.MarketId)
                .Index(t => t.ScreenshotDbId);
                ...
                c => new
                    {
                        ...
                        InitialMargin = c.Decimal(nullable: false, precision: 18, scale: 2),
                        MTT = c.Int(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        ProfitTakerPrice = c.Decimal(nullable: false, precision: 18, scale: 2),
                        ExitDate = c.DateTime(),
                        ...
                        TradingAccountId = c.Int(nullable: false),
                        TradingDayId = c.Int(nullable: false),
                        EntryScreenshotDbId = c.Int(),
                        ExitScreenshotDbId = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Screenshots", t => t.EntryScreenshotDbId)
                .ForeignKey("dbo.Screenshots", t => t.ExitScreenshotDbId)
                .ForeignKey("dbo.Markets", t => t.MarketId, cascadeDelete: true)
                .ForeignKey("dbo.TradingAccounts", t => t.TradingAccountId, cascadeDelete: true)
                .ForeignKey("dbo.TradingDays", t => t.TradingDayId, cascadeDelete: true)
                .Index(t => t.MarketId)
                .Index(t => t.TradingAccountId)
                .Index(t => t.TradingDayId)
                .Index(t => t.EntryScreenshotDbId)
                .Index(t => t.ExitScreenshotDbId);
                ...
                c => new
                    {
                        ...
                        CumulativeProfitK = c.Decimal(nullable: false, precision: 18, scale: 2),
                        CumulativeProfit = c.Decimal(nullable: false, precision: 18, scale: 2),
                        TradingEdge = c.Boolean(nullable: false),
                        ConsecutiveLossesK = c.Decimal(nullable: false, precision: 18, scale: 2),
                        ConsecutiveLosses = c.Int(nullable: false),
                        MaxDrawdownK = c.Decimal(nullable: false, precision: 18, scale: 2),
                        MaxDrawdown = c.Decimal(nullable: false, precision: 18, scale: 2),
                        AccountSize = c.Decimal(nullable: false, precision: 18, scale: 2),
                        RuinPoint = c.Decimal(nullable: false, precision: 18, scale: 2),
                        MaxDrawdownMultiple = c.Decimal(nullable: false, precision: 18, scale: 2),
                        OneContractFunds = c.Decimal(nullable: false, precision: 18, scale: 2),
                        MaxContracts = c.Int(nullable: false),
                        MarketMaxContractsJson = c.String(),
                        TradingAccountId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.TradingAccounts", t => t.TradingAccountId, cascadeDelete: true)
